describe('doublyLinkedList', function() {
  ...
  it('should return true for node retrieved from middle of the list', function() {
    doublyLinkedList.addToTail(4);
  ...
  it('should have a null next property if it is a tail', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.tail.next).to.equal(null);
  });

  it('should add new head to list when "addToHead" is called', function() {
    doublyLinkedList.addToHead(8);
    expect(doublyLinkedList.head.value).to.equal(8);
  });

  it('should return the tail value when "removeTail" is called', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
